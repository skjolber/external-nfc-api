...
public class NdefAdapter extends DefaultTechnology implements NdefTechnology {

    private static final String TAG = NdefAdapter.class.getName();

    private NdefOperations operations;

    public NdefAdapter(int slotNumber, NdefOperations operations) {
        super(TagTechnology.NDEF, slotNumber);
    ...
    public String toString() {
        return Ndef.class.getSimpleName();
    }
